...
export default function RegisterPage() {
  ...
  return (
    <main className="min-h-screen bg-[url('/bg.png')] bg-cover bg-center px-4 py-6 sm:px-6 sm:py-8">
      <div className="mx-auto w-full max-w-2xl rounded-[32px] border border-slate-800 bg-slate-900/80 p-6 shadow-2xl shadow-black/30 backdrop-blur-xl sm:p-8">
        ...
        <form onSubmit={handleRegister} className="mt-8 space-y-5">
          ...
          <div className="flex flex-col gap-3 rounded-3xl border border-slate-800 bg-slate-800/70 p-4">
            <p className="text-sm font-medium text-slate-300">Register as</p>
            <div className="flex flex-wrap gap-3">
              <button
                type="button"
                className={`rounded-full px-4 py-2 text-sm ${role === "student" ? "bg-sky-600 text-white" : "bg-slate-900 text-slate-300 border border-slate-700"}`}
              ...
              <button
                type="button"
                className={`rounded-full px-4 py-2 text-sm ${role === "teacher" ? "bg-sky-600 text-white" : "bg-slate-900 text-slate-300 border border-slate-700"}`}
